...
* It will take some time for the WebLogic configuration to properly deploy. Once the deployment completes, in the portal go to 'All resources'. Find and click on adminServerVM. 
Open the connection security panel. Enable access to Azure services and disable SSL connection enforcement. Hit Save.
